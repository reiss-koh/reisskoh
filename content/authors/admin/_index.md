...
👋 Hi! I am interested in expanding what is possible for humanity. To this end, I primarily work on **Foundation Models** and **Agents**. Currently, I am working on a generative world model for VLM agent training. Previously, I have worked on pre-training, post-training, reasoning, self-evolution, agents, and scalable feedback/evaluation, and inference-time scaling. I am perfectly bilingual in English and Korean. If you have similar interests, let's connect.

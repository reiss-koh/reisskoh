...
👋 Hi! I am interested in pushing humanity's boundary. To this end, I primarily work on **Foundation Models** and **Agents**. Currently, I am working on a GUI world model for VLM agent training. Previously, I have worked on pre-training, post-training, reasoning, self-evolution, agents, and scalable feedback. I am perfectly bilingual in English and Korean. Feel free to check out my publications below.
